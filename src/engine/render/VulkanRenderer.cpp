...
void VulkanRenderer::initSurface(VkSurfaceKHR surface) {
...
void VulkanRenderer::setVerticesAndIndices(const std::vector<Vertex> &vertices, const std::vector<uint32_t> &indices) {
...
void VulkanRenderer::resetVertexRange(const std::vector<Vertex> &vertices, size_t start, size_t size, size_t arrStart) {
...
void VulkanRenderer::createVertexBuffer(const std::vector<Vertex> &vertices, bool update, size_t start, size_t size, size_t arrStart) {
    if (size == 0) {
        size = vertices.size();
    }
...
void VulkanRenderer::createIndexBuffer(const std::vector<uint32_t> &indices, bool update, size_t start, size_t size, size_t arrStart) {
...
void VulkanRenderer::copyBuffer(VkBuffer srcBuffer, VkBuffer dstBuffer, VkDeviceSize dstOffset, VkDeviceSize size) {
    VkCommandBuffer commandBuffer = beginSingleTimeCommands();
